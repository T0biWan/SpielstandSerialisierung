...
public class Latrunculi {
   ...
   public static void main(String [] args) {
      ...
      // Wir haben ja darüber geredet es mit einer if-Abfrage zu machen,
      // allerdings verlangen io-Streams immer Exception Handling...?
      try {
      ...
      if (spielfeld.siegerehrung()) {} else {
         // Konsolenausgabe
         ...
         do {
            ...
            if (!spielfeld.spielzugLegal(xBreiteAlt, yHoeheAlt, xBreiteNeu, yHoeheNeu)) {
               System.out.println("--------------------------------------------------------------------------------");
