...
public class Spielfeld implements Serializable {
   ...
   /*
    * Konstruktoren Hier wird ein neues Spielfeld im Startzustand erzeugt. Die
    * zwei For-Schleifen füllen das Spielfeld mit 7 blauen und 7 roten Steinen
   ...
   /*
    * Oberklasse Koordinaten, alterStand und neuerStand wird mitgegeben Suche
    * nach Steinen, die diese alten Koordinaten haben, um diesen dann zu
    * verändern Nur wenn er ihn findet und der Zug legal ist, wird er
    * ausgeführt sonst wird false zurückgegeben
    */
   public boolean steinZiehen(int xBreiteAlt, int yHoeheAlt, int xBreiteNeu, int yHoeheNeu) {
    ...
    * gegebenen Koordinaten, d.h. seine position enthält. Diese Methode sucht
    * einen Stein an den gesuchten Koordinaten und gibt ihn, wenn vorhanden,
    * zurück.
    */
   ...
   public Boolean spielzugLegal(int xBreiteAlt, int yHoeheAlt, int xBreiteNeu, int yHoeheNeu) {
      if (imWertebereich(xBreiteAlt, yHoeheAlt) && imWertebereich(xBreiteNeu, yHoeheNeu)) {
    ...
    */
   public Boolean imWertebereich(int xBreite, int yHoehe) {
      return (xBreite > -1 && xBreite <= MAX && yHoehe > -1 && yHoehe <= MAX);
   }

   /*
    * Wir suchen den Stein, der bewegt werden soll, und schauen, ob wir uns in
    * einer geraden oder ungeraden Runde befinden. Sind wir in einer geraden,
    * muss der Stein blau sein, für ungerade rot. Wir wollen nicht, dass roter
    * Spieler blaue Steine bewegt.
    */
   ...
   /*
    * Diese Methode guckt, ob das Feld, auf das der Stein bewegt werden soll,
    * wirklich frei ist. Die search-Methode gibt null bei leerem Feld zurück.
    */
   public Boolean feldFrei(int xBreiteNeu, int yHoeheNeu) {
      return (searchStein(xBreiteNeu, yHoeheNeu) == null);
   }
   ...
   private void zeigeGeschlageneSteine(Farbe farbe) {
      ...
      for (int i = 0; i <= 6; i++) {
         if (zähler > 0) {
            System.out.print("|" + sletter); // macht einen kleinbuchstaben
                                             // daraus
            zähler--;
         } else {
            System.out.print("| ");
   ...
   public void grafischeDarstellung() {
      ...
      // Erstelle Spielfeld
      // die zwei for-Schleifen gehen unsere Liste der Spielsteine durch und
      // setzen die Spielsteine in das Feld.
   ...
   /*
    * Wir schauen, ob ein schlagbarer Stein existiert. Wenn ja, wird der Stein
    * "geschlagen" gesetzt (true) und aus der Spielstein-Liste herausgenommen
    * (remove).
    */
   public void steinSchlagen(int xBreiteNeu, int yHoeheNeu) {

      Spielstein steinOben = schlagbarOben(xBreiteNeu, yHoeheNeu);
      if (steinOben != null) {
         steinOben.setGeschlagen(true);
      }

      Spielstein steinUnten = schlagbarUnten(xBreiteNeu, yHoeheNeu);
      if (steinUnten != null) {
         steinUnten.setGeschlagen(true);
      }

      Spielstein steinLinks = schlagbarLinks(xBreiteNeu, yHoeheNeu);
      if (steinLinks != null) {
         steinLinks.setGeschlagen(true);
      }

      Spielstein steinRechts = schlagbarRechts(xBreiteNeu, yHoeheNeu);
      if (steinRechts != null) {
    ...
    * Sollte dies stimmen, schauen wir, ob es darüber (y = -2) einen Stein
    * unserer Farbe gibt. Wenn ja, gibt die Methode den schlagbaren Stein
    * zurück. Die anderen Methoden machen dasselbe, nur in die anderen
    * Richtungen. (Unten, Links und Rechts).
    */
   public Spielstein schlagbarOben(int xBreiteNeu, int yHoeheNeu) {
      Spielstein stein = searchStein(xBreiteNeu, yHoeheNeu);
      if (stein != null) {
         Farbe steinfarbe = stein.getFarbe();
         Spielstein nebenliegenderStein = searchStein(xBreiteNeu, yHoeheNeu - 1);
         if (nebenliegenderStein != null) {
            if (steinfarbe != nebenliegenderStein.getFarbe()) {
               Spielstein nebenNebenliegenderStein = searchStein(xBreiteNeu, yHoeheNeu - 2);
               if (nebenNebenliegenderStein != null) {
                  if (steinfarbe == nebenNebenliegenderStein.getFarbe()) { return nebenliegenderStein; }
               }
            }
         }
      }
   ...
   public Spielstein schlagbarUnten(int xBreiteNeu, int yHoeheNeu) {
      Spielstein stein = searchStein(xBreiteNeu, yHoeheNeu);
      if (stein != null) {
         Farbe steinfarbe = stein.getFarbe();
         Spielstein nebenliegenderStein = searchStein(xBreiteNeu, yHoeheNeu + 1);
   ...
   public Spielstein schlagbarLinks(int xBreiteNeu, int yHoeheNeu) {
      Spielstein stein = searchStein(xBreiteNeu, yHoeheNeu);
      if (stein != null) {
         Farbe steinfarbe = stein.getFarbe();
         Spielstein nebenliegenderStein = searchStein(xBreiteNeu - 1, yHoeheNeu);
         if (nebenliegenderStein != null) {
            if (steinfarbe != nebenliegenderStein.getFarbe()) {
               Spielstein nebenNebenliegenderStein = searchStein(xBreiteNeu - 2, yHoeheNeu);
               if (nebenNebenliegenderStein != null) {
                  if (steinfarbe == nebenNebenliegenderStein.getFarbe()) { return nebenliegenderStein; }
               }
            }
   ...
   public Spielstein schlagbarRechts(int xBreiteNeu, int yHoeheNeu) {
      Spielstein stein = searchStein(xBreiteNeu, yHoeheNeu);
      if (stein != null) {
         Farbe steinfarbe = stein.getFarbe();
         Spielstein nebenliegenderStein = searchStein(xBreiteNeu + 1, yHoeheNeu);
   ...
   /*
    * Sind die geschlagenen Steine groesser als 5? Wenn ja, wird die Variable
    * siegerRot oder Blau auf true gesetzt.
    */
   ...
   /*
    * Gibt eine Siegerehrung aus. Nur eine Textnachricht. Ob jemand gewonnen
    * hat, wird in Latrunculi in der Main überprüft.
    */
